...
class PerturbationTool():
    ...
    def min_min_attack_robust(self, images, labels, model, optimizer, criterion, robust_noise, robust_noise_step,
                              avgtimes_perturb, outer_pbar, random_noise=None, sample_wise=False):
